...
const ForwardConsentForm = () => {
    ...
    const { forwardConsentFormQuestionsQueryData: {
        loading: forwardConsentFormQuestionsLoading,
        called: forwardConsentFormQuestionsCalled,
    }, initForwardConsentFormQuestions } =
        ForwardConsentFormQuestionsQuery();
    ...
    //Adverticesment
    const [isAdvertisement, setIsAdvertisement] = useState(0);
    ...
    //HANDLE NEXT BUTTON
    const handleNext = () => {
        console.log('questionsListquestionsListquestionsList', questionsList);
        const newAnswer = questionsList?.map((ans) => {
            // let answerNew = -1;
            // if (ans?.answer == 'Yes') {
            //     answerNew = 1;
            ...
            return {
                // ...ans,
                identifier: ans.questionId,
                question: ans.content,
                answer: ans?.answer === 1 ? true : false, 
                answerNew: ans?.answer,
                comment: ans?.comment,
            };
        });
        if (!trimmedDataURL && !signedSignatureData) {
    ...
    const handleOptionChange = (index, option, comment) => {
        const updatedQuestions = [...questionsList];
        updatedQuestions[index] = { ...updatedQuestions[index], answer: option, comment: comment };
                                                    ...
                                                    <div className="CustomeCompleteConsentForm Custome540Width">
                                                        ...
                                                        <div className="ConsentQuestion">
                                                            {questionsList?.length === 0 &&
                                                                ...
                                                                questionsList?.length !== 0 && questionsList?.map((question, index) => {
                                                                    return <QuestionsList key={question.questionId} index={index} question={question} onChange={(option, comment) => handleOptionChange(index, option, comment)} />
                                                                })
                                                            )}
                                                        </div>
                                                    ...
                                                    <div className={!isPayMonthButton ? "CustomePaymentCons CustomePayMonthly" : "CustomePaymentCons"}>
                                                        ...
                                                        {selectedPaymentOption ==
                                                            ...
                                                            paymentStatusData[0]?.is_ryft_setup && bookingId != null && forwardConsentBookingAccountId != null &&
                                                                        ...
                                                                        <div ref={
                                                                            ...
                                                                            <RyftComponent
                                                                                ...
                                                                                ryftDataObj={
                                                                                    ...
                                                                                    selectedPaymentOption == "Pay in full"
                                                                                    ? {
                                                                                        payableAmount: `£${paymentSummary?.totalAppointmentAmount?.toFixed(
                                                                                            2
                                                                                        )}`,
                                                                                        }
                                                                                    : selectedPaymentOption === "Pay Deposit"
                                                                ...
                                                                <SkeletonLoader type="forward-consent-payment" />
                                                            ) : // !selectedPaymentOptionData?.paymentByPass && selectedPaymentOption === "Pay on the Day" ? <StripeComponent
                                                                ...
                                                                // date: moment(appointmentDetails?.appointmentDate, ("Do MMMM YYYY")).format('M') == 9 ?
                                                                //     `${moment(appointmentDetails?.appointmentDate, ("Do MMMM YYYY")).format('Do')
                                                                //     } Sept.${moment(appointmentDetails?.appointmentDate, ("Do MMMM YYYY")).format('YYYY')}` :
                                                                //     `${moment(appointmentDetails?.appointmentDate, ("Do MMMM YYYY")).format('Do MMM. YYYY')}`,
                                                                // treatmentCount: treatmentDetails?.length,
                                                                // treatmentNames: treatmentDetails?.map(treatment => treatment.treatmentName).join(","),
                                                                //treatmentPrice: `£${paymentSummary?.totalAppointmentAmount?.toFixed(2)}`,
                                                                ...
                                                                //totalDue: `£${paymentSummary?.dueAmount?.toFixed(2)}`,
                                                                //     }
                                                                //     isPayOnTheDay={selectedPaymentOptionData?.payOnTheDay}
                                                                //     noShowPolicy={true}
                                                                //     setStep={setStep}
                                                                        ...
                                                                        <StripeComponent
                                                                            ...
                                                                            stripeDataObj={
                                                                                ...
                                                                                selectedPaymentOption ==
                                                                                    'Pay in full'
                                                                                    ? {
                                                                                        payableAmount: `£${paymentSummary?.totalAmount?.toFixed(2)}`,
                                                                                        bookingfees: `£${((paymentSummary?.totalAmount / 100) * (paymentSummary.commissionPercentage)).toFixed(2)}`, // Calculate booking fees as 2% of totalAppointmentAmount
                                                                                        grandTotal: `£${(parseFloat(paymentSummary?.totalAmount) + (paymentSummary?.totalAmount / 100) * (paymentSummary?.commissionPercentage)).toFixed(2)}`
                                                                                    }
                                                                                    : {
                                                                                        payableAmount: `£${paymentSummary?.depositAmount?.toFixed(2)}`,
